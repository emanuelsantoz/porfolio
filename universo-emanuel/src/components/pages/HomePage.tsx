  ...
  return (
    <main className="portfolio-shell bg-[#f8f7f3] text-[#07111f]">
      ...
      <section id="contato" className="bg-[#07111f] px-6 py-24 text-white lg:px-10 lg:py-32">
        ...
        <div className="mx-auto mt-20 flex max-w-7xl items-center justify-between border-t border-white/10 pt-6 text-xs text-white/45"><span>Emanuel Santos</span><span>ES/01 · 2026</span></div>
      </section>
    </main>
  );
}
